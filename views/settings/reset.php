  ...
  session_start();
      ...
      if ($_SERVER['REQUEST_METHOD']=='POST')
      {
        ...
        { 
           ...
           header('Location: complete-reset');
        }
        else
        {
          $msg=$return['message'];
...
<!--[if lte IE 8]><script src="js/libs/selectivizr.js"></script><![endif]-->
  <title> Reset | Create Events and Search for vendors | oyinspire.me</title>
     <meta charset="utf-8" />
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        <h3 class="text-centered">Enter your Email</h3>        

      	<form class="set" action="reset" method="post" data-parsley-validate="">      
