<?php
 ...
 $dash='<a onclick="javascript:accountMenu()">
    ...
    else if ($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      if (updateCustomerProfile($_POST,$_SESSION['username'])===true)
        { 
          $user=getCustomerProfile($_SESSION['username']);
          $msg="Successful";
        }
        ...
        <form class="updateform" action="" method="post" enctype="multipart/form-data" data-parsley-validate="">
           ...
           <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            ...
            <div class="image-preview">
              <img id="img-preview" height="200" width="200" src="<?php echo $user['profile_image']; ?>">
            </div>
          ...
          <div class="form-group">        
            ...
            <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $user['firstname']?>" required="" placeholder="Enter First name">
          </div>
          </div>
          ...
          <div class="form-group">        
            ...
            <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo $user['lastname']?>" required="" placeholder="Enter Last name">
          </div>
          </div>          
          ...
          <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="radio">        
              <label for="sex">
                <input type="radio" required="" <?php if($user['sex']==1)echo "checked";?> id="sex" name="sex" value="1">Male
              </label>
              <label for="sex"> 
                <input type="radio" <?php if($user['sex']==2) echo "checked"; ?>  id="sex" name="sex" value="2">Female
              </label>
            </div>             
          </div> 
